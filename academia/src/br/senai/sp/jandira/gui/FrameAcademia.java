	...
	public class FrameAcademia {
		...
		public void criarTela(){
			...
			// JLabel Atiidade
				...
				// ButtonGroup Nivel de Atividade
//				ButtonGroup groupAtividade = new ButtonGroup();
//				
//				JRadioButton radioNenhuma = new JRadioButton();
//				groupAtividade.add(radioNenhuma);
//				JRadioButton radioLeve = new JRadioButton();
//				groupAtividade.add(radioLeve);
//				
//				radioLeve.setBounds(460, 120, 90, 30);
//				radioLeve.setText("Leve");
//				radioNenhuma.setBounds(460, 90, 90, 30);
//				radioNenhuma.setText("Nenhuma");
				
				// ButtonGroup Nivel de Atividade
				
				
//				JRadioButton radioModerada = new JRadioButton();
//				groupAtividade.add(radioModerada);
//				JRadioButton radioIntensa = new JRadioButton();
//				groupAtividade.add(radioIntensa);
//				
//				radioModerada.setBounds(460, 150, 90, 30);
//				radioModerada.setText("Moderada");
//				radioIntensa.setBounds(460, 180, 90, 30);
//				radioIntensa.setText("Intensa");
...
//			tela.getContentPane().add(radioLeve);
//			tela.getContentPane().add(radioNenhuma);
//			tela.getContentPane().add(radioModerada);
//			tela.getContentPane().add(radioIntensa);
